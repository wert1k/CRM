...
public class CrmApplication {
	...
	public static void main(String[] args) {
		...
		String parser2 = "Страница: http://www.java-mentor.com/index.html Форма: Java Test 1: 2 3: 3 4: 2 5: 3 6: 4 Имя: testew Social 2: https://vk.com/andiovermide Phone 6: 89110812259 City 6: Россия Email 2: mcdncrnc73@gmail.com";
...
//		SpringApplication.run(CrmApplication.class, args);
	...
	private static Long validatorTestResult(String parseContent) {
        ...
        List result = Arrays.asList("3", "3", "1", "2", "3", "4");
        List resultList = Arrays.asList(indexQuery.split("\\s*\\s*"));
		List resultTest = Arrays.asList(listQuery.split("\\s*\\s*"));

        System.out.println(resultList);
        System.out.println(resultTest);

        for (int q = 0, count = 0, i = 0; i < resultTest.size(); i++) {
            if (result.get(i).equals(resultTest.get(i + q))) {
                count++;
